...
export class ViewReportComponent implements OnInit, OnDestroy {
  ...
  downloadReport(): void {
    ...
    const rows = this.data.map((row) => ({
      ...
      P1_ToxStartLoad: this.getProcessValue(row, 1, 'toxStartLoad'),
      P1_ToxEndLoad: this.getProcessValue(row, 1, 'toxEndLoad'),
      P1_ToxMidLoad: this.getProcessValue(row, 1, 'toxMidLoad'),
      P1_ToxStartDisplacement: this.getProcessValue(row, 1, 'toxStartDisplacement'),
      P1_ToxEndDisplacement: this.getProcessValue(row, 1, 'toxEndDisplacement'),
      P1_ToxMidDisplacement: this.getProcessValue(row, 1, 'toxMidDisplacement'),
      ...
      P2_ToxStartLoad: this.getProcessValue(row, 2, 'toxStartLoad'),
      P2_ToxEndLoad: this.getProcessValue(row, 2, 'toxEndLoad'),
      P2_ToxMidLoad: this.getProcessValue(row, 2, 'toxMidLoad'),
      P2_ToxStartDisplacement: this.getProcessValue(row, 2, 'toxStartDisplacement'),
      P2_ToxEndDisplacement: this.getProcessValue(row, 2, 'toxEndDisplacement'),
      P2_ToxMidDisplacement: this.getProcessValue(row, 2, 'toxMidDisplacement'),
